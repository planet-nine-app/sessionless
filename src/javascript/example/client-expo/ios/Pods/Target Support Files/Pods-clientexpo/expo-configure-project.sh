...
with_node \
  ...
  --target "/Users/zachbabb/Work/planet-nine/sessionless/src/javascript/example/client-expo/ios/Pods/Target Support Files/Pods-clientexpo/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-constants" "expo-crypto" "expo-file-system" "expo-keep-awake" "expo-secure-store"
